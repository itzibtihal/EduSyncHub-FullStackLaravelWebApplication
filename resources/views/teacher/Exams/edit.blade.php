        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <div class="card">
                    ...
                    <form class="form-card" action="{{ route('teacher.exams.update', $exam->id) }}" method="post">
                        @csrf
                        @method('post')
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-12 flex-column d-flex">
                                ...
                                <textarea name="comment" id="" cols="3" rows="2" placeholder="Comment here" required>{{ $exam->comment }}</textarea>
                            </div>
                        </div>
