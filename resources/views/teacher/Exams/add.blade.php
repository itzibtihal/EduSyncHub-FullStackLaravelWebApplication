        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <div class="card">
                    ...
                    <form class="form-card" action="{{ route('teacher.exams.store') }}" method="post">
                        @csrf
                        <input type="hidden" name="created_by" value="{{ Auth::id() }}">
                        <input type="hidden" name="professor_id" value="{{ Auth::id() }}">

                        <h3 class="mb-4">Add an Exam</h3>
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-12 flex-column d-flex">
                                <label class="form-control-label px-3">Exam Title<span
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex">
                                <label class="form-control-label px-3">Duration (in minutes):<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex">
                                <label class="form-control-label px-3">Base Note<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <div class="form-group col-12 flex-column d-flex">
                                ...
                                <textarea name="comment" id="" cols="3" rows="2" placeholder="Comment here" required></textarea>
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-12 flex-column d-flex">
                                ...
                                <select name="cycle_id" id="school_cycle" style="width: 60%;margin-left: 0px;"  class="custom-select">
                                ...
                                <div class="select-container" style="width: 60%;margin-top: 4px;">
                                    ...
                                    <select name="level_id" id="speciality" class="custom-select">
                                ...
                                <div class="select-container" style="margin-left: 80px; width: 60%;margin-top: 4px;">
                                    <i class="fas fa-caret-down"></i>
                                    <select name="speciality_id" id="speciality" class="custom-select">
